...
<script type="text/javascript" src="console/scripts/includes/less.config.js"></script>
		...
		<style>
			#LoginPage #LoginHeader {
				background:#0D6070 !important;
			}
			#LoginPage #LoginFormContainer > .body .formactions button, #LoginPage #LoginFormContainer > .body .formactions input[type="submit"], #LoginPage #LoginFormContainer > .body .formactions input[type="button"], #LoginPage #LoginFormContainer > .body .formactions a.button {
				outline-color: #0D6070;
				border-color: #0D6070;
				background: #0D6070 !important;
				-webkit-box-shadow: 0px 2px 1px #0D6070 inset;
				-moz-box-shadow: 0px 2px 1px #0D6070 inset;
				-o-box-shadow: 0px 2px 1px #0D6070 inset;
				box-shadow: 0px 2px 1px #0D6070 inset;
			}
		</style>
		...
		<div class="body">
			<form id="LoginForm" action="<%=actionUrl%>" method="post">
				...
				<div class="formactions">					
					<input type="submit" value="Login" <%=disableLogin ? "disabled=\"disabled\" " : ""%> /><br /> <br />ou 
					<a href='http://localhost:8080/bonita/console/homepage?ui=form#form=Login--1.0$entry&process=7490047136519877048&mode=app&locale=pt'>Cadastre-se</a>
				</div>
			</form>
		</div>
	</div>
